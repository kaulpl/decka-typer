...
class DT_Admin {
    ...
    public static function settings(): void {
        ...
        echo '<section class="dt-card"><span class="dt-eyebrow">REKLAMY</span><h2>Symulacja slotów reklamowych</h2><label class="dt-check"><input type="checkbox" name="ad_slot_preview" value="1" '.checked(!empty($s['ad_slot_preview']),true,false).'><span><strong>Pokazuj testowe miejsca reklamowe</strong><small>Administrator zobaczy pomarańczowe makiety D1 i D2 z nazwą oraz wymaganym wymiarem 970 × 250 px. Zwykli użytkownicy nadal widzą wyłącznie aktywne kampanie.</small></span></label><p class="dt-muted"><a href="'.esc_url(admin_url('admin.php?page=decka-typer-ads')).'">Przejdź do zarządzania kampaniami →</a></p></section>';
