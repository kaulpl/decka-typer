...
class DT_Admin {
    ...
    public static function settings(): void {
        ...
        echo '<section class="dt-card"><span class="dt-eyebrow">REKLAMY</span><h2>Symulacja slotów reklamowych</h2><label class="dt-check"><input type="checkbox" name="ad_slot_preview" value="1" '.checked(!empty($s['ad_slot_preview']),true,false).'><span><strong>Pokazuj testowe miejsca reklamowe</strong><small>Administrator zobaczy pomarańczowe makiety H1 i F1 (1920 × 125 px) oraz boczne S1 i S2 (160 × 600 px). Zwykli użytkownicy nadal widzą wyłącznie aktywne kampanie.</small></span></label><p class="dt-muted"><a href="'.esc_url(admin_url('admin.php?page=decka-typer-ads')).'">Przejdź do zarządzania kampaniami →</a></p></section>';
